...
$select=mysqli_query($koneksi,"select * from pembayaran,penyewaan where pembayaran.idpenyewaan=penyewaan.idpenyewaan and month(pembayaran.jatuhtempo)<='$blnini' and year(pembayaran.jatuhtempo)<='$tahunini' and pembayaran.statuspembayaran='Belum bayar' and penyewaan.idkamar between '$level1' and '$level2' order by pembayaran.jatuhtempo asc,penyewaan.idkamar asc");
...
<td><?php echo date("d-m-Y",strtotime($jatuhtempo=$ambil['jatuhtempo'])); ?></td>
<td><?php echo 'Rp.'.number_format($da['tarif'], 0, ',', '.'); ?></td>
...
<td><?php  
 ...
 if($tglskrng>$jatuhtempo){
echo '<a href="menunggak-pembayaran.php?idpembayaran=';
echo $ambil['idpembayaran']."
&&idpenyewaan=
".$ambil['idpenyewaan']."
&&jatuhtempo=
".$ambil['jatuhtempo']."
...
".$bayar.'"> <button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Menunggak</i></button></a>';
 ...
 ?>
 <a href="input-pembayaran.php?idpembayaran=<?php echo $ambil['idpembayaran'];?>"><button type="button" class="btn btn-primary mb-3"><i class="fa fa-pencil"> Bayar</i></button></a></td>
