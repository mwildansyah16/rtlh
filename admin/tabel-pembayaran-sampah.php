                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								<form  role="form" action="cetak-pembayaran-sampah.php" target="_blank" method="POST" >
								<div class="row">
...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from sampah,penyewaan where sampah.idpenyewaan=penyewaan.idpenyewaan and penyewaan.idkamar between '$level1' and '$level2' group by sampah.idpenyewaan order by penyewaan.idkamar asc");
$jml1=0;
$jml2=0;
$jml3=0;
$jml4=0;
