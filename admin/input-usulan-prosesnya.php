...
$simpan= mysqli_query($koneksi,"insert into penerima values ('','$a','$b','$c','$d','$da','$db','$e','$f','$g','$h','$i','$ii','$j','$k','$l','$m','$n','$o','$p','$q','$r','$s','$t','$u','$v','$w','$x','$y','$z','$aa','$ab','$ac','$ad','$ae','$af','$ag','$ah','$ai','$aj','$ak','$al','$foto1','$foto2','$foto3','$foto4','$am','$an','')"); // query insert
?>
