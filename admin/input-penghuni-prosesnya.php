...
$i='peninjauan';
$j=addslashes($_POST['idkamar']);
$k=addslashes($_POST['tglpenyewaan']);
$l=0;
$m='peninjauan';

$simpan1= mysqli_query($koneksi,"insert into penghuni values ('$a','$ab','$b','$c','$d','$e','$f','$g','$h','$i')"); // query insert
$simpan2= mysqli_query($koneksi,"insert into penyewaan values ('','$a','$j','$k','$l','$m')"); // query insert
$simpan3=mysqli_query($koneksi,"update kamar set statuskamar='terisi' where idkamar='$j'"); // query insert
?>
