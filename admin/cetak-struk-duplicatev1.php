...
<head>
	...
	<style type="text/css">
		...
		.gambare{
			background-image: url(../assets/images/icon/penghuni-baru.png);
			background-position: right;
			background-size: 170mm;
...
$aa=$_GET['idpenyewaan'];
$a=$_GET['idpembayaran']; 
$cek9=mysqli_query($koneksi,"select * from struk where idpenyewaan='$aa' and idpembayaran='$a' and token='0'");
if(mysqli_num_rows($cek9)>0) {
	echo "<script>alert('Maaf, struk asli dan duplicatnya sudah pernah tercetak. Jadi, tidak bisa dicetak lagi.')</script>";
...
<tr>
	...
	<table width="100%" border=1>
		<?php
		$dfg=mysqli_query($koneksi,"update struk set token='0' where idpenyewaan='$aa' and idpembayaran='$a'");
...
?>
		<tr>
			...
			<td colspan="3">
				...
				<h1 style='font-size:150%;'>STRUK PEMBAYARAN SEWA HUNIAN RUSUNAWA</h1>
				<hr>
				<table width="75%">
				<tr>
				...
				<tr>
				<td>NIK</td><td>:</td><td><?php echo $gom['idpenghuni']; ?></td><td></td><td>Unit hunian</td><td>:</td><td>
				<?php $kama=$gom['idkamar']; 
				...
				<tr>
				<td>Tgl Pembayaran</td><td>:</td><td><?php echo date("d-m-Y",strtotime($da['tglpembayaran'])); ?></td><td></td><td>Keterangan</td><td>:</td><td>Bayar pertama</td>
				</tr>
				</table>
				<table width="100%">
				<tr>
...
?>
				...
				<table>
				<tr>
				<td><b>Tarif</b></td><td><b>:</b></td><td><b><?php echo 'Rp.'.number_format($tarife=$da['tarifsaatitu'], 0, ',', '.').',-'; ?></b></td>
				</tr>
				<tr>
				<td><b>Total Bayar</b></td><td><b>:</b></td><td><b><?php echo 'Rp.'.number_format($totale=$da['bayar'], 0, ',', '.').',-'; ?></b></td>
				</tr>
