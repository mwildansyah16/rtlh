...
<?php
$idpenerima=$_GET['idpenerima'];

				include '../koneksi.php';
                $query2= mysqli_query($koneksi,"SELECT * FROM penerima where idpenerima=$idpenerima");
...
<tr><th style="border:1px solid #000;" rowspan=3>10</th><th style="border:1px solid #000;" rowspan=3>PENGHASILAN ATAU PENGELUARAN PER BULAN</th><th><input type="checkbox"  class="largerCheckbox"name="toping" <?php if ($row2['penghasilan']=="KURANG 1,2 JUTA"){ echo "checked"; }?> onclick="return false;">
...
2,7 - 3,1 JUTA</th><th style="border-right:1px solid #000;" colspan=2><input type="checkbox"  class="largerCheckbox"name="toping" <?php if ($row2['penghasilan']=="LEBIH 4,2"){ echo "checked"; }?> onclick="return false;">
&gt; 4,2 JUTA</th><th></th><th style="border:1px solid #000;">1</th><th style="border-bottom:1px solid #000; border-right:1px solid #000;">LUAS RUMAH (M2)</th><th style="border-bottom:1px solid #000; border-right:1px solid #000;" colspan=3><?php echo $row2['luas']; ?></th></tr>
...
<a href="<?php echo $row2['fotodepan'];?>" target="_blank"><img src="<?php echo $row2['fotodepan'];?>" width="150px" height="80px"></a></button></center></th><th>
