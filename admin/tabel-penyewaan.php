                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Penyewaan</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="admin.php">Home</a></li>
                                <li><span>Data penyewaan</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data penyewaan</h4> 
...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from penyewaan,penghuni where penyewaan.idpenghuni=penghuni.idpenghuni and penyewaan.statuspenyewaan='peninjauan' and penyewaan.idkamar between '$level1' and '$level2'order by idpenyewaan desc");
while ($ambil=mysqli_fetch_array($select)){
?>
<tr>
<td><?php echo $no++; ?><?php $ambil['idpenyewaan']; ?></td>
<td><?php echo $ambil['idpenghuni']; ?></td>
<td><?php echo $ambil['nama']; ?></td>
<td><?php echo $ambil['idkamar']; ?></td>
<td><?php echo date("d-m-Y",strtotime($ambil['tglpenyewaan'])); ?></td>
<td><a href="input-penyewaan-baru.php?idpenyewaan=<?php echo $ambil['idpenyewaan'];?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Bayar</i></button></a></td>
