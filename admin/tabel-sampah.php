            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data sampah</h4> 
...
$select=mysqli_query($koneksi,"select * from sampah,penyewaan where sampah.idpenyewaan=penyewaan.idpenyewaan and month(sampah.jthtempo)<'$blnini' and year(sampah.jthtempo)<='$tahunini' and sampah.stsbyr='Belum bayar' and penyewaan.idkamar between '$level1' and '$level2' order by sampah.jthtempo asc,penyewaan.idkamar asc");
...
<td><?php echo date("d-m-Y",strtotime($jthtempo=$ambil['jthtempo'])); ?></td>
<td><?php 
$tglskrng=date("Y-m-d");
$tanggalee=$ambil['jthtempo'];
if($tanggalee<'2021-09-01'){
		$bayar=8000;
...
$tglskrng1=date('Y-m-d', strtotime('-1 month', strtotime($tglskrng)));
 if($tglskrng1>$jthtempo){
echo '<a href="menunggak-sampah.php?idsampah=';
echo $ambil['idsampah']."
&&idpenyewaan=
".$ambil['idpenyewaan']."
&&jthtempo=
".$ambil['jthtempo']."
&&byr=
".$bayar.'"> <button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Menunggak</i></button></a>';
 }
 else{
	 echo '';
 }
 ?>
 <a href="input-sampah.php?idsampah=<?php echo $ambil['idsampah'];?>"><button type="button" class="btn btn-primary mb-3"><i class="fa fa-pencil"> Bayar</i></button></a></td>
