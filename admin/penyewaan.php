            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data penyewaan (Silahkan melunasi semua tagihan, sebelum menon aktifkan penyewaan)</h4> 
...
$select=mysqli_query($koneksi,"select * from penyewaan where statuspenyewaan='Aktif' and idkamar between '$level1' and '$level2' order by idkamar asc");
...
<td><?php echo $ambil['statuspenyewaan']; ?></td>
<td><a href="nonaktifkan.php?idpenyewaan=<?php echo $ambil['idpenyewaan'];?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Non aktifkan</i></button></a></td>
