...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from air,penyewaan where air.idpenyewaan=penyewaan.idpenyewaan and air.stsbyrair='Lunas' and air.tglbyrair between '$tglawala' and '$tglakhira' and penyewaan.idkamar between '$level1' and '$level2' order by air.tglbyrair asc,penyewaan.idkamar asc");
$jml1=0;
$jml2=0;
$jml3=0;
$total=0;
...
<td><?php echo $ambil['volume']; ?></td>
<td><?php echo 'Rp.'.number_format($ambil['byrair'], 0, ',', '.'); ?></td>
<?php $hasil1=$ambil['byrair'];  $jml1+=$hasil1;?>
<td><?php echo date("d-m-Y",strtotime($ambil['tglbyrair'])); ?></td>
