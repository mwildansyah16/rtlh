...
if (($da ['volume']<=0)){
	...
	echo "<script>alert('Volume air sudah diisi!!!')</script>";
...
?>
											...
											<div class="form-group">
                                                <label>Volume</label>
                                                <input type="number" class="form-control" id="volume" name="volume"  onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" value="<?php echo $da1 ['volume'];?>" required>
                                            </div>
											<div class="form-group">
                                                <label>Tarif</label>
