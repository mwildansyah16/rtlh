...
<tr>
<td><?php echo $no++; ?> <?php $idairnya1=$ambil['idair']; ?> <?php $ambil['idpenyewaan']; ?></td>
<?php
include "../koneksi.php";
...
<td>
<?php $fotoairnya1=$ambil['fotoair'];
if ($fotoairnya1==''){
	echo '<a href="input-air.php?idair='.$idairnya1.'"><button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Input</i></button></a>';
}else{
	
}
 ?>
<!--<a href="input-air.php?idair=<?php echo $ambil['idair'];?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Input</i></button></a>--> <a href="bayar-air.php?idair=<?php echo $ambil['idair'];?>"><button type="button" class="btn btn-primary mb-3"><i class="fa fa-pencil"> Bayar</i></button></a></td>
