...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from air,penyewaan where air.idpenyewaan=penyewaan.idpenyewaan and year(air.jthtmpair)='$tglawala' and penyewaan.idkamar between '$level1' and '$level2' group by air.idpenyewaan order by penyewaan.idkamar asc");
$jml1=0;
$jml2=0;
$jml3=0;
$jml4=0;
...
<p>Laporan perbulan : <?php echo date("Y",strtotime($tglawala)); ?></p>
