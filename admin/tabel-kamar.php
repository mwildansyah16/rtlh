                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Kamar</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="admin.php">Home</a></li>
                                <li><span>Data kamar</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data kamar</h4> 
...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from kamar where idkamar between '$level1' and '$level2' order by idkamar asc");
while ($ambil=mysqli_fetch_array($select)){
?>
<tr>
<td><?php echo $no++; ?></td>
<td><?php echo $ambil['idkamar']; ?></td>
<td><?php echo 'Rp.'.number_format($ambil['tarif'], 0, ',', '.'); ?></td>
<td><?php echo $ambil['statuskamar']; ?></td>
