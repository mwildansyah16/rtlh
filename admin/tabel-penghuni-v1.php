            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data penghuni</h4> 
								<form  role="form" action="cetak-penghuni.php" target="_blank" method="POST" >
								<div class="row">
...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from penghuni,penyewaan where penghuni.idpenghuni=penyewaan.idpenghuni and penghuni.statuspenghuni='aktif' and penyewaan.idkamar between '$level1' and '$level2' order by penyewaan.idkamar asc");
...
$que=mysqli_query($koneksi,"select *from penyewaan,penghuni,kamar where penyewaan.idpenghuni=penghuni.idpenghuni and penyewaan.idkamar=kamar.idkamar and penyewaan.idpenghuni='$idx'");
$da = mysqli_fetch_array($que);
?>
<td><?php echo $da['idkamar']; ?></td>
<td><?php echo $ambil['alamat']; ?></td>
<td><?php echo $ambil['jenkel']; ?></td>
<td><a target="_blank" href="<?php echo $ambil['foto']; ?>"><button type="button" class="btn btn-primary mb-3"><?php echo $ambil['foto']; ?></button></a></td>
<td><?php echo $ambil['jmlpenghuni']; ?></td>
<td><?php echo $ambil['nohp']; ?></td>
<td><?php echo $ambil['nohpsaudara']; ?></td>
<td><?php echo $ambil['statuspenghuni']; ?></td>
<td><a href="edit-penghuni.php?idpenghuni=<?php echo $ambil['idpenghuni'];?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-pencil"> Edit</i></button></a></td>
