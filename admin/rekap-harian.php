                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Data rekap harian</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								<form  role="form" action="cetak-rekap-harian-sewa.php" target="_blank" method="POST" >
								<div class="row">
...
if(mysqli_num_rows($cek2)<1) {
	?>
	<a href="input-struk.php?idpenyewaan=<?php echo $idpeny;?>&&idpembayaran=<?php echo $idpem;?>"><button type="button" class="btn btn-primary mb-3"><i class="fa fa-pencil"> Buat</i></button></a>
...
<?php
	...
	if($cek4==0){
		...
		if($cek4==1){
			?>
			<a target='_blank' href="cetak-struk-duplicate.php?idpenyewaan=<?php echo $idpeny;?>&&idpembayaran=<?php echo $idpem;?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-print"> Duplicate</i></button></a>
			<?php
		}else{
		?>
		<a target='_blank' href="cetak-struk.php?idpenyewaan=<?php echo $idpeny;?>&&idpembayaran=<?php echo $idpem;?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-print"> Cetak</i></button></a>
