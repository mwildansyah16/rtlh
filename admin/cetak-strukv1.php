...
?>
	...
	?>
				...
				<p>Terima Kasih.</br>Jika terjadi tidak kesesuaian data terhadap struk pembayaran ini, silahkan menghubungi admin terkait.</br><?php echo tglIndonesia(date('Y-m-d')); ?></p></center></td>
				</tr>
				</table>
