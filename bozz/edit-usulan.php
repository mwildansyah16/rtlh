...
<body>
    ...
    <div class="page-container">
        ...
        <?php include "menu-bozz.php";?>
        <!-- sidebar menu area end -->
        <!-- main content area start -->
        <div class="main-content">
            <!-- header area start -->
            <?php include "header-bozz.php";?>
            <!-- header area end -->
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="bozz.php">Dashboard</a></li>
                                <li><span>Input usulan</span></li>
                            </ul>
                        </div>
                    </div>
                    <?php include "toolbar-kanan-bozz.php";?>
                </div>
            </div>
            <!-- page title area end -->
...
?>
										<form action='edit-usulan-prosesnya.php'enctype="multipart/form-data" method="POST">
											...
											<div class="form-group">
												...
												<input type="date" class="form-control" id="tglsurvey" name="tglsurvey" value="<?php echo $da['tglsurvey']; ?>" required>
											</div>
											<div class="form-group">
												<label><b>Nama Petugas Surveyor</b></label>
												<input type="text" class="form-control" id="petugas" name="petugas" value="<?php echo $da['petugas']; ?>"  required>
											</div>
											<div class="form-group">
												<label><b>NIK</b></label>
												<input type="number" class="form-control" id="nik" name="nik" value="<?php echo $da['nik']; ?>"  >
											</div>
											<div class="form-group">
												<label><b>No KK</b></label>
												<input type="number" class="form-control" id="nokk" name="nokk" value="<?php echo $da['nokk']; ?>"  >
											</div>
											<div class="form-group">
                                            <label><b>Apakah Terdaftar di DTKS</b></label>
                                            <select style="height:45px;" class="form-control" name="dtks" id="dtks" >
                                                <option><?php echo $da['nodtks']; ?></option>
												<option>Tidak</option>
												<option>Ya</option>
											</select>
			...
			if ($("#dtks option:selected").val() == 'Ya') {
				...
				$('#bb').prop('hidden', true);
                                            ...
                                            <select style="height:45px;" class="form-control" name="prioritas" id="prioritas" >
                                                <option><?php echo $da['prioritas']; ?></option>
												<option>1</option>
												<option>2</option>
												<option>3</option>
												<option>4</option>
											...
											<div class="form-group">
												...
												<input type="number" class="form-control" id="jmlkk" name="jmlkk" value="<?php echo $da['jmlkk']; ?>"  >
											</div>
											<div class="form-group">
												<label><b>Nama</b></label>
												<input type="text" class="form-control" id="nama" name="nama" value="<?php echo $da['nama']; ?>"  required>
											</div>
											<div class="form-group">
												<label><b>Usia</b></label>
												<input type="number" class="form-control" id="usia" name="usia" value="<?php echo $da['usia']; ?>"  >
											</div>
											<div class="form-group">
											<label><b>Kecamatan</b></label>
<select style="height:45px;" class="form-control"  id="kecamatan" name="kecamatan" required>
<option><?php echo $da['kecamatan']; ?></option>
...
<select style="height:45px;" class="form-control"  id="desa" name="desa" required>
                <option><?php echo $da['desa']; ?></option>
...
<?php } ?>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="alamatlengkap" name="alamatlengkap" value="<?php echo $da['alamatlengkap']; ?>"  required>
											</div>
											<div class="form-group">
                                            <label><b>Pendidikan terakhir</b></label>
                                            <select style="height:45px;" class="form-control" name="pendidikan" id="pendidikan" >
                                                <option><?php echo $da['pendidikan']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="jenkel" id="jenkel" required>
                                                <option><?php echo $da['jenkel']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="pekerjaan" id="pekerjaan" >
                                                <option><?php echo $da['pekerjaan']; ?></option>
												<option>PNS</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="penghasilan" id="penghasilan" >
                                                <option><?php echo $da['desa']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="statustanah" id="statustanah" >
                                                <option><?php echo $da['statustanah']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="statusrumah" id="statusrumah" >
                                                <option><?php echo $da['statusrumah']; ?></option>
												<option>MILIK SENDIRI</option>
												<option>BUKAN MILIK SENDIRI</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="asetrumah" id="asetrumah" >
                                                <option><?php echo $da['asetrumah']; ?></option>
												<option>ADA</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="asettanah" id="asettanah" >
                                                <option><?php echo $da['asettanah']; ?></option>
												<option>ADA</option>
												<option>TIDAK ADA</option>
											</select>
											</div>
                                            ...
                                            <select style="height:45px;" class="form-control" name="statusbantuan" id="statusbantuan" >
                                                <option><?php echo $da['statusbantuan']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="jeniskawasan" id="jeniskawasan" >
                                                <option><?php echo $da['jeniskawasan']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="pondasi" id="pondasi" >
                                                <option><?php echo $da['pondasi']; ?></option>
												<option>BAIK</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="sloof" id="sloof" >
                                                <option><?php echo $da['sloof']; ?></option>
												<option>BAIK</option>
												<option>RUSAK RINGANA</option>
												<option>RUSAK SEDANG/SEBAGIAN</option>
												<option>RUSAK BERAT/SELURUHNYA</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="kolom" id="kolom" >
                                                <option><?php echo $da['kolom']; ?></option>
												<option>BAIK</option>
												<option>RUSAK RINGANA</option>
												<option>RUSAK SEDANG/SEBAGIAN</option>
												<option>RUSAK BERAT/SELURUHNYA</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="balok" id="balok" >
                                                <option><?php echo $da['balok']; ?></option>
												<option>BAIK</option>
												<option>RUSAK RINGANA</option>
												<option>RUSAK SEDANG/SEBAGIAN</option>
												<option>RUSAK BERAT/SELURUHNYA</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="strukturatap" id="strukturatap" >
                                                <option><?php echo $da['strukturatap']; ?></option>
												<option>BAIK</option>
												<option>RUSAK RINGANA</option>
												<option>RUSAK SEDANG/SEBAGIAN</option>
												<option>RUSAK BERAT/SELURUHNYA</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="jendela" id="jendela" >
                                                <option><?php echo $da['jendela']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="ventilasi" id="ventilasi" >
                                                <option><?php echo $da['ventilasi']; ?></option>
												<option>ADA, MENCUKUPI</option>
												<option>ADA, TIDAK MENCUKUPI</option>
												<option>TIDAK ADA</option>
											</select>
                                            ...
                                            <select style="height:45px;" class="form-control" name="jarakair" id="jarakair" >
                                                <option><?php echo $da['jarakair']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="sumberair" id="sumberair" >
                                                <option><?php echo $da['sumberair']; ?></option>
												<option>PDAM</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="sumberlistrik" id="sumberlistrik" >
                                                <option><?php echo $da['sumberlistrik']; ?></option>
                                            ...
                                            <div class="form-group">
												...
												<input type="number" class="form-control" id="luas" name="luas" value="<?php echo $da['luas']; ?>" >
											</div>
											<div class="form-group">
												<label><b>Jumlah Penghuni (Orang)</b></label>
												<input type="number" class="form-control" id="jmlpenghuni" name="jmlpenghuni" value="<?php echo $da['jmlpenghuni']; ?>" >
											</div>
											<div class="form-group">
                                            <label><b>Material Atap Terluas</b></label>
                                            <select style="height:45px;" class="form-control" name="atap" id="atap" >
                                                <option><?php echo $da['atap']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="kondisiatap" id="kondisiatap" >
                                                <option><?php echo $da['kondisiatap']; ?></option>
												<option>BAIK</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="dinding" id="dinding" >
                                                <option><?php echo $da['dinding']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="kondisidinding" id="kondisidinding" >
                                                <option><?php echo $da['kondisidinding']; ?></option>
												<option>BAIK</option>
												<option>RUSAK RINGAN</option>
												<option>RUSAK SEDANG/SEBAGIAN</option>
												<option>RUSAK BERAT/SELURUHNYA</option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="lantai" id="lantai" >
                                                <option><?php echo $da['lantai']; ?></option>
                                            ...
                                            <select style="height:45px;" class="form-control" name="kondisilantai" id="kondisilantai" >
                                                <option><?php echo $da['kondisilantai']; ?></option>
												<option>BAIK</option>
												<option>RUSAK RINGAN</option>
												<option>RUSAK SEDANG/SEBAGIAN</option>
												<option>RUSAK BERAT/SELURUHNYA</option>
                                            ...
                                            <div class="form-group">
                                            <label><b>Intervensi</b></label>
                                            <select style="height:45px;" class="form-control" name="intervensi">
                                                <option>APBD Kabupaten</option>
												<option>Bankeupemdes (APBD Provinsi)</option>
												<option>DAK</option>
												<option>BSPS</option>
												<option>PB Relokasi Penghuni Rusun (APBD Provinsi)</option>
												<option>Baznas</option>
												<option>CSR PT. Djarum</option>
												<option>CSR PT. Polytron</option>
												<option>CSR. Nojorono</option>
											</select>
											</div>	
											<div class="form-group">
                                            <label><b>Tahun</b></label>
                                            <select style="height:45px;" class="form-control" name="tahun">
                                                <option>2024</option>
												<option>2025</option>
												<option>2026</option>
												<option>2027</option>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" name="latitude" id="latitude" value="<?php echo $da['latitude']; ?>">
												<input type="text" class="form-control" name="longitude" id="longitude" value="<?php echo $da['longitude']; ?>">

											</div>
											<div class="form-group">
                                                <label><b>Foto Rumah (Tampak Depan)</b></label>
												<br><img src="<?php echo $da['fotodepan'];?>" width="150px" height="80px">
												<a href="ganti-foto-depan.php?idpenerima=<?php echo $idpenerima;?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-eye"></i> Ganti</button>
											</div>
											<div class="form-group">
                                                <label><b>Foto Rumah (Tampak Samping)</b></label>
                                                <br><img src="<?php echo $da['fotosamping'];?>" width="150px" height="80px">
												<a href="ganti-foto-samping.php?idpenerima=<?php echo $idpenerima;?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-eye"></i> Ganti</button>
											</div>		
                                            <div class="form-group">
                                                <label><b>Foto Rumah (Dalam Rumah)</b></label>
                                                <br><img src="<?php echo $da['fotodalam'];?>" width="150px" height="80px">
												<a href="ganti-foto-dalam.php?idpenerima=<?php echo $idpenerima;?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-eye"></i> Ganti</button>
											</div>
											<div class="form-group">
                                                <label><b>Foto Rumah (Kamar Mandi)</b></label>
                                                <br><img src="<?php echo $da['fotokm'];?>" width="150px" height="80px">
												<a href="ganti-foto-km.php?idpenerima=<?php echo $idpenerima;?>"><button type="button" class="btn btn-success mb-3"><i class="fa fa-eye"></i> Ganti</button>
											</div>	
