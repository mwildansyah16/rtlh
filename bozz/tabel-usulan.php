                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								<form  role="form" action="cetak-usulan2.php" target="_blank" method="POST" >
								<div class="row">
...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from penerima where kesimpulan='' order by kecamatan asc,desa asc, nama asc");
...
<a href="acc-usulan.php?idpenerima=<?php echo $ambil['idpenerima'];?>"><button type="button" class="btn btn-warning mb-3"><i class="fa fa-check"> </i></button></a></td>
</tr>
<?php 
}
?>
