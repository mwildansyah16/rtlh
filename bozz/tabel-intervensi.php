...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from penerima where kesimpulan='Tidak layak'  and intervensi!='' order by kecamatan asc,desa asc, nama asc");
...
<td>
<a href="lihat-usulan.php?idpenerima=<?php echo $ambil['idpenerima'];?>" target="_blank"><button type="button" class="btn btn-primary mb-3"><i class="fa fa-eye"> </i></button></a>
<a href="batalkan-intervensi.php?idpenerima=<?php echo $ambil['idpenerima'];?>"><button type="button" class="btn btn-warning mb-3"><i class="fa fa-close"> </i></button></a></td>
</tr>
<?php 
}
?>
