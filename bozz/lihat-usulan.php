...
<img src="<?php echo $row2['fotodepan'];?>" width="250px" height="180px"><img src="<?php echo $row2['fotosamping'];?>" width="250px" height="180px"><img src="<?php echo $row2['fotodalam'];?>" width="250px" height="180px"><img src="<?php echo $row2['fotokm'];?>" width="250px" height="180px"></center></th><th>
