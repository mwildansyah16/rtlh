            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">DATA RUMAH TIDAK LAYAK</h4> 
								<form  role="form" action="cetak-usulan3.php" target="_blank" method="POST" >
								<div class="row">
...
<?php } ?>
								...
								<!--<div class="form-group col-md-3">
												<label><b>Tanggal Survey Awal</b></label>
												<input type="date" class="form-control" id="tglsurvey1" name="tglsurvey1"  required>
								</div>
								<div class="form-group col-md-3">
												<label><b>Tanggal Survey Akhir</b></label>
												<input type="date" class="form-control" id="tglsurvey2" name="tglsurvey2"  required>
								</div>-->
								...
								<a target="_blank" href="cetak-usulan4.php"><button type="button" class="btn btn-primary mb-3">Cetak semua</button></a>
...
$no=1;
$tahunini=date("Y");
$select=mysqli_query($koneksi,"select * from penerima where kesimpulan='Tidak layak' order by kecamatan asc,desa asc, nama asc");
...
<a href="lihat-usulan.php?idpenerima=<?php echo $ambil['idpenerima'];?>" target="_blank"><button type="button" class="btn btn-primary mb-3"><i class="fa fa-eye"> </i></button></a> <a href="hapus-usulan.php?idpenerima=<?php echo $ambil['idpenerima'];?>"><button type="button" class="btn btn-danger mb-3"><i class="fa fa-trash"> </i></button></a>
<a href="batalkan-acc.php?idpenerima=<?php echo $ambil['idpenerima'];?>"><button type="button" class="btn btn-warning mb-3"><i class="fa fa-close"> </i></button></a></td>
</tr>
<?php 
}
?>
